...
Systematic traders generally use sensitivity analysis to identify the set conditions under which the *trading system* will operate within acceptable bounds. In the this report, we refer to this set of conditions as the *operational domain* of the strategy (for a specific set of trading model parameters). The broader the spectrum of market conditions over which a trading system can perform within acceptable performance bounds (i.e. the broader the operational domain of the strategy), the more *robust* the system.
...
The project .Rmd file assembles the visualization and text comprising the report.
